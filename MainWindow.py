...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.barf, 10, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnstop, 14, 1, 1, 1)
        ...
        self.foco.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border-radius: 35px;\n"
...
"color: rgb(239, 117, 255);")
        ...
        self.barl = QProgressBar(self.centralwidget)
        self.barl.setObjectName(u"barl")
        self.barl.setMaximumSize(QSize(125, 16777215))
        self.barl.setValue(0)

        self.gridLayout.addWidget(self.barl, 9, 4, 1, 1)

        self.bar = QProgressBar(self.centralwidget)
        self.bar.setObjectName(u"bar")
        self.bar.setMaximumSize(QSize(16777215, 16777215))
        self.bar.setValue(100)

        self.gridLayout.addWidget(self.bar, 12, 3, 1, 2)

        self.table = QTableView(self.centralwidget)
        self.table.setObjectName(u"table")

        self.gridLayout.addWidget(self.table, 0, 0, 14, 3)
        ...
        self.gridLayout.addWidget(self.label, 11, 3, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Air Leakage", None))
        self.btnstop.setText(QCoreApplication.translate("MainWindow", u"Detener", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Air Blockage", None))
        self.foco.setText("")
        self.btnstart.setText(QCoreApplication.translate("MainWindow", u"Iniciar", None))
        self.lbcondicion.setText("")
        self.lbpredicciones.setText(QCoreApplication.translate("MainWindow", u"Normal Conditions", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"PREDICCIONES CORRECTAS POR \n"
"ESTADO DE FUNCIONAMIENTO", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"PORCENTAJE DE PREDICCIONES CORRECTAS", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"CONDICIONES DE FUNCIONAMIENTO", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"PREDICCI\u00d3N CORRECTA/INCORRECTA", None))
    # retranslateUi
